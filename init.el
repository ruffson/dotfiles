...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (urscript-mode ibuffer-sidebar all-the-icons-dired dired-sidebar ag projectile xkcd which-key use-package doom-modeline highlight-symbol beacon doom-themes centaur-tabs highlight-indent-guides magit py-autopep8 flycheck elpy ein))))
(custom-set-faces
